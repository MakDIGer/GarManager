...
{
	cout << endl;
	buffer_line = "E:\\Garant-FS80\\Download.exe -auto -dsc 90 -nofinalmessage -to " + day;
	...
	if (check_file("E:\\Garant-FS80\\delta\\","zip"))
	{
...
int copy_etalon(int copy_mode)
{
	...
	pcs monster("\\\\monster\\Garant.Srv\\F80\\","\\\\monster\\Garant.Srv\\start.txt");
	pcs rex("\\\\rex\\Garant.Srv\\F80\\","\\\\rex\\Garant.Srv\\start.txt");
	pcs rr10("\\\\rr10\\Garant.Srv\\F80\\","\\\\rr10\\Garant.Srv\\start.txt");
	pcs usepc1("E:\\Garant.SRV\\F80\\","E:\\Garant.SRV\\start.txt");
	
	data = "";
	data1 = "E:\\Garant-FS80\\data1\\";
	data2 = "E:\\Garant-FS80\\data2\\";
...
void dataupd()
{
	cout << "E:\\Garant-Fs80\\DATAUPD.exe -auto  -nofinalmessage" << endl;
	run_cmd("E:\\Garant-Fs80\\DATAUPD.exe -auto  -nofinalmessage");
	Sleep(300000);
...
int main()
{
	...
	clearDIR("E:\\garant.srv\\F80\\");
	
	cout << "Deleting files at the delta directory................." << endl;
	clearDIR("E:\\Garant-FS80\\delta\\Archive\\");
	clearDIR("E:\\Garant-FS80\\delta\\");
